...
function randomword(){
  $dictionary = array('like','just','love','know','never','want','time',
      ...
      $random_word = $dictionary[array_rand($dictionary,1)];
      return $random_word;
}

function generate_mnemonic(){
    $mnemonic = randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword().randomword().' '.randomword().' '.randomword().' '.randomword().' '.randomword();
    return $mnemonic;
}
